defmodule SignuisWeb.Accounts.UserSettingsControllerTest do
  ...
  describe "GET /accounts/users/settings" do
  ...
  describe "PUT /accounts/users/settings (change password form)" do
  ...
  describe "PUT /accounts/users/settings (change email form)" do
    @tag :capture_log
  ...
  describe "GET /accounts/users/settings/confirm_email/:token" do
    setup %{user: user} do
