...
import { DynamicMap, DynamicMarker, DynamicMarkerLayer } from "@/components/leaflet/dynamic";
import { Report } from "@/lib/model";
import { CalendarIcon, CircleStackIcon, MapPinIcon, UserIcon } from "@heroicons/react/20/solid";
...
export function ReportList(props: ReportListProps) {
    ...
    return <div className="flex flex-wrap">
        {page.map((report) => <div key={`report-${report.id}`} className="m-2 w-39 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
